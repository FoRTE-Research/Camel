...
@zero = common dso_local global i16 0, align 2
...
if.end4:                                          ; preds = %if.end, %if.then
  ...
  call void asm sideeffect "mov $0, SP", "ri"(i16 %3) #7, !dbg !147, !srcloc !150
  %4 = bitcast i16* %__x to i8*, !dbg !151
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #7, !dbg !151
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !118, metadata !DIExpression()), !dbg !151
  %5 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !151, !srcloc !152
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #7, !dbg !153
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #7, !dbg !155
  call void @llvm.dbg.declare(metadata i16* %__x5, metadata !120, metadata !DIExpression()), !dbg !155
  %11 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !155, !srcloc !156
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %13) #7, !dbg !157
...
define dso_local void @commit() #4 !dbg !185 {
entry:
  %__x = alloca i16, align 2
  %tmp = alloca i16, align 2
...
if.then:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #7, !dbg !208
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !187, metadata !DIExpression()), !dbg !208
  %3 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !208, !srcloc !209
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #7, !dbg !210
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #7, !dbg !212
  call void @llvm.dbg.declare(metadata i16* %__x1, metadata !192, metadata !DIExpression()), !dbg !212
  %9 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !212, !srcloc !213
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #7, !dbg !214
...
if.else:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %19) #7, !dbg !234
  call void @llvm.dbg.declare(metadata i16* %__x7, metadata !194, metadata !DIExpression()), !dbg !234
  %20 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !234, !srcloc !235
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #7, !dbg !236
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %25) #7, !dbg !238
  call void @llvm.dbg.declare(metadata i16* %__x10, metadata !197, metadata !DIExpression()), !dbg !238
  %26 = call i16 asm sideeffect "mov SP, $0", "=r"() #7, !dbg !238, !srcloc !239
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #7, !dbg !240
...
define dso_local void @task_done() #5 !dbg !256 {
entry:
  call void @exit(i16 0) #8, !dbg !257
  unreachable, !dbg !257
}
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_init() #5 !dbg !258 {
entry:
  %i = alloca i16, align 2
  %message_length = alloca i16, align 2
  %0 = bitcast i16* %i to i8*, !dbg !263
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !263
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #7, !dbg !265
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %14) #7, !dbg !301
  %15 = bitcast i16* %i to i8*, !dbg !301
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %15) #7, !dbg !301
  ret void, !dbg !301
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_pad() #5 !dbg !302 {
entry:
  %i = alloca i16, align 2
  %zero = alloca i16, align 2
  %0 = bitcast i16* %i to i8*, !dbg !306
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !306
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %5) #7, !dbg !316
...
for.end34:                                        ; preds = %for.cond25
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %34) #7, !dbg !387
  %35 = bitcast i16* %i to i8*, !dbg !387
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %35) #7, !dbg !387
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_exp() #5 !dbg !388 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_mult_block() #5 !dbg !405 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_mult_block_get_result() #5 !dbg !409 {
entry:
  %i = alloca i16, align 2
  %op = alloca i16, align 2
  %0 = bitcast i16* %i to i8*, !dbg !420
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !420
...
for.body11:                                       ; preds = %for.cond9
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %14) #7, !dbg !456
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %24) #7, !dbg !466
...
if.end26:                                         ; preds = %if.end, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #7, !dbg !475
  ret void, !dbg !475
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_square_base() #5 !dbg !476 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_square_base_get_result() #5 !dbg !480 {
entry:
  %i = alloca i16, align 2
  %0 = bitcast i16* %i to i8*, !dbg !483
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !483
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %9) #7, !dbg !505
  ret void, !dbg !505
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_mult_mod() #5 !dbg !506 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_mult() #5 !dbg !514 {
entry:
  %i = alloca i16, align 2
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %15) #7, !dbg !555
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %31) #7, !dbg !576
...
if.end30:                                         ; preds = %if.then27, %for.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %46) #7, !dbg !602
  %47 = bitcast i16* %dp to i8*, !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %47) #7, !dbg !602
  %48 = bitcast i16* %c to i8*, !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %48) #7, !dbg !602
  %49 = bitcast i16* %b to i8*, !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %49) #7, !dbg !602
  %50 = bitcast i16* %a to i8*, !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %50) #7, !dbg !602
  %51 = bitcast i16* %i to i8*, !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %51) #7, !dbg !602
  ret void, !dbg !602
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_digits() #5 !dbg !603 {
entry:
  %d = alloca i16, align 2
  %0 = bitcast i16* %d to i8*, !dbg !606
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !606
...
if.end:                                           ; preds = %if.then, %do.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %14) #7, !dbg !637
  ret void, !dbg !637
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_normalizable() #5 !dbg !638 {
entry:
  %i = alloca i16, align 2
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !647
  call void @llvm.dbg.declare(metadata i16* %i, metadata !640, metadata !DIExpression()), !dbg !648
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %normalizable) #7, !dbg !649
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %7) #7, !dbg !665
...
cleanup:                                          ; preds = %if.end19, %if.then18, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %23) #7, !dbg !689
...
if.end33:                                         ; preds = %if.else30, %if.then27
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %normalizable) #7, !dbg !716
  %32 = bitcast i16* %i to i8*, !dbg !716
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %32) #7, !dbg !716
  ret void, !dbg !716
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_normalize() #5 !dbg !717 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %7) #7, !dbg !744
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #7, !dbg !778
...
if.end18:                                         ; preds = %if.else15, %if.then13
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %33) #7, !dbg !795
  %34 = bitcast i16* %borrow to i8*, !dbg !795
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %34) #7, !dbg !795
  %35 = bitcast i16* %s to i8*, !dbg !795
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %35) #7, !dbg !795
  %36 = bitcast i16* %d to i8*, !dbg !795
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %36) #7, !dbg !795
  %37 = bitcast i16* %n to i8*, !dbg !795
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %37) #7, !dbg !795
  %38 = bitcast i16* %m to i8*, !dbg !795
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %38) #7, !dbg !795
  ret void, !dbg !795
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_n_divisor() #5 !dbg !796 {
entry:
  %op1 = alloca i16, align 2
  %op2 = alloca i16, align 2
  %0 = bitcast i16* %op1 to i8*, !dbg !800
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !800
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #7, !dbg !802
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %9) #7, !dbg !813
  %10 = bitcast i16* %op1 to i8*, !dbg !813
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %10) #7, !dbg !813
  ret void, !dbg !813
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_quotient() #5 !dbg !814 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #7, !dbg !826
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %6) #7, !dbg !830
...
do.end:                                           ; preds = %do.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %50) #7, !dbg !891
  %51 = bitcast i16* %op2 to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %51) #7, !dbg !891
  %52 = bitcast i16* %op1 to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %52) #7, !dbg !891
  %53 = bitcast i32* %n_q to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %53) #7, !dbg !891
  %54 = bitcast i32* %qn to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %54) #7, !dbg !891
  ret void, !dbg !891
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_multiply() #5 !dbg !892 {
entry:
  %i = alloca i16, align 2
  %m = alloca i16, align 2
  %n = alloca i16, align 2
...
if.then:                                          ; preds = %for.body4
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %17) #7, !dbg !948
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #7, !dbg !960
...
for.end17:                                        ; preds = %for.cond2
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %34) #7, !dbg !977
  %35 = bitcast i16* %c to i8*, !dbg !977
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %35) #7, !dbg !977
  %36 = bitcast i16* %n to i8*, !dbg !977
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %36) #7, !dbg !977
  %37 = bitcast i16* %m to i8*, !dbg !977
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %37) #7, !dbg !977
  %38 = bitcast i16* %i to i8*, !dbg !977
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %38) #7, !dbg !977
  ret void, !dbg !977
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_compare() #5 !dbg !978 {
entry:
  %i = alloca i16, align 2
  %relation = alloca i8, align 1
  %0 = bitcast i16* %i to i8*, !dbg !983
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #7, !dbg !983
  call void @llvm.dbg.declare(metadata i16* %i, metadata !980, metadata !DIExpression()), !dbg !984
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %relation) #7, !dbg !985
...
if.end17:                                         ; preds = %if.then15, %for.end
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %relation) #7, !dbg !1028
  %17 = bitcast i16* %i to i8*, !dbg !1028
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %17) #7, !dbg !1028
  ret void, !dbg !1028
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_add() #5 !dbg !1029 {
entry:
  %i = alloca i16, align 2
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %5) #7, !dbg !1044
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %32) #7, !dbg !1101
  %33 = bitcast i16* %c to i8*, !dbg !1101
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %33) #7, !dbg !1101
  %34 = bitcast i16* %n to i8*, !dbg !1101
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %34) #7, !dbg !1101
  %35 = bitcast i16* %m to i8*, !dbg !1101
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %35) #7, !dbg !1101
  %36 = bitcast i16* %j to i8*, !dbg !1101
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %36) #7, !dbg !1101
  %37 = bitcast i16* %i to i8*, !dbg !1101
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %37) #7, !dbg !1101
  ret void, !dbg !1101
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_reduce_subtract() #5 !dbg !1102 {
entry:
  %i = alloca i16, align 2
  %m = alloca i16, align 2
  %s = alloca i16, align 2
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #7, !dbg !1116
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %5) #7, !dbg !1116
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #7, !dbg !1171
  %28 = bitcast i16* %borrow to i8*, !dbg !1171
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #7, !dbg !1171
  %29 = bitcast i16* %qn to i8*, !dbg !1171
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %29) #7, !dbg !1171
  %30 = bitcast i16* %s to i8*, !dbg !1171
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %30) #7, !dbg !1171
  %31 = bitcast i16* %m to i8*, !dbg !1171
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %31) #7, !dbg !1171
  %32 = bitcast i16* %i to i8*, !dbg !1171
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %32) #7, !dbg !1171
  ret void, !dbg !1171
}
...
while.body:                                       ; preds = %entry, %while.end
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast, i8* align 2 %BCast3, i16 202, i1 false), !dbg !1182
...
if.then:                                          ; preds = %while.body2
  ...
  %global4 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global, i32 0, i32 6
  %array = getelementptr inbounds [16 x i16], [16 x i16]* %global4, i16 0, i16 0
  %cast = bitcast i16* %array to i8*
  %tmp5 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global6 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp5, i32 0, i32 1
  %global7 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global6, i32 0, i32 6
  %array8 = getelementptr inbounds [16 x i16], [16 x i16]* %global7, i16 0, i16 0
  %cast9 = bitcast i16* %array8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast, i8* align 2 %cast9, i16 32, i1 false), !dbg !1190
  ...
  %global12 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global11, i32 0, i32 15
  %tmp13 = load i16, i16* @zero, align 2
  %access = getelementptr inbounds [16 x i16], [16 x i16]* %global12, i16 0, i16 %tmp13
  %tmp14 = load i16, i16* %access, align 2
  %tmp15 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global16 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp15, i32 0, i32 1
  %global17 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global16, i32 0, i32 15
  %tmp18 = load i16, i16* @zero, align 2
  %access19 = getelementptr inbounds [16 x i16], [16 x i16]* %global17, i16 0, i16 %tmp18
  ...
  %global22 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global21, i32 0, i32 15
  %array23 = getelementptr inbounds [16 x i16], [16 x i16]* %global22, i16 0, i16 0
  %cast24 = bitcast i16* %array23 to i8*
  %tmp25 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global26 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp25, i32 0, i32 1
  %global27 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global26, i32 0, i32 15
  %array28 = getelementptr inbounds [16 x i16], [16 x i16]* %global27, i16 0, i16 0
  %cast29 = bitcast i16* %array28 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast24, i8* align 2 %cast29, i16 32, i1 false), !dbg !1190
  %tmp30 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global31 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp30, i32 0, i32 1
  %global32 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global31, i32 0, i32 1
  %tmp33 = load i16, i16* %global32, align 2
  %tmp34 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global35 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp34, i32 0, i32 1
  %global36 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global35, i32 0, i32 1
  store i16 %tmp33, i16* %global36, align 2
  %tmp37 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global38 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp37, i32 0, i32 1
  %global39 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global38, i32 0, i32 3
  ...
  %global46 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global45, i32 0, i32 17
  ...
  %global50 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global49, i32 0, i32 17
...
if.then6:                                         ; preds = %if.end
  ...
  %global53 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global52, i32 0, i32 1
  ...
  %global57 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global56, i32 0, i32 1
  ...
  %global60 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global59, i32 0, i32 17
  ...
  %global64 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global63, i32 0, i32 17
...
if.then11:                                        ; preds = %if.end7
  ...
  %global67 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global66, i32 0, i32 18
  ...
  %global71 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global70, i32 0, i32 18
...
if.then15:                                        ; preds = %if.else
  ...
  %global74 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global73, i32 0, i32 18
  ...
  %global78 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global77, i32 0, i32 18
...
if.end17:                                         ; preds = %if.end16, %if.then11
  ...
  %global81 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global80, i32 0, i32 8
  ...
  %global85 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global84, i32 0, i32 8
  store i16 %tmp82, i16* %global85, align 2
  %tmp86 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global87 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp86, i32 0, i32 1
  %global88 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global87, i32 0, i32 9
  %tmp89 = load i16, i16* %global88, align 2
  %tmp90 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global91 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp90, i32 0, i32 1
  %global92 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global91, i32 0, i32 9
...
do.body:                                          ; preds = %do.cond, %if.end17
  ...
  %global95 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global94, i32 0, i32 0
  ...
  %global98 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global97, i32 0, i32 8
  %load = load i16, i16* %global98, align 2
  %access99 = getelementptr inbounds [16 x i16], [16 x i16]* %global95, i16 0, i16 %load
  ...
  %global106 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global105, i32 0, i32 8
  %load107 = load i16, i16* %global106, align 2
  %access108 = getelementptr inbounds [16 x i16], [16 x i16]* %global103, i16 0, i16 %load107
  ...
  %global111 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global110, i32 0, i32 8
  %tmp112 = load i16, i16* %global111, align 2
  %tmp113 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global114 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp113, i32 0, i32 1
  %global115 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global114, i32 0, i32 8
  ...
  %global118 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global117, i32 0, i32 9
  ...
  %global122 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global121, i32 0, i32 9
...
do.end:                                           ; preds = %do.cond
  ...
  %global125 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global124, i32 0, i32 17
  ...
  %global129 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global128, i32 0, i32 17
  ...
  %global132 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global131, i32 0, i32 10
  ...
  %global136 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global135, i32 0, i32 10
...
if.end24:                                         ; preds = %do.end
  ...
  %global139 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global138, i32 0, i32 12
  ...
  %global143 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global142, i32 0, i32 12
  ...
  %global146 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global145, i32 0, i32 17
  ...
  %global150 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global149, i32 0, i32 17
...
if.then28:                                        ; preds = %if.end24
  ...
  %global153 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global152, i32 0, i32 0
  %array154 = getelementptr inbounds [16 x i16], [16 x i16]* %global153, i16 0, i16 0
  %cast155 = bitcast i16* %array154 to i8*
  %tmp156 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global157 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp156, i32 0, i32 1
  %global158 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global157, i32 0, i32 0
  %array159 = getelementptr inbounds [16 x i16], [16 x i16]* %global158, i16 0, i16 0
  %cast160 = bitcast i16* %array159 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast155, i8* align 2 %cast160, i16 32, i1 false), !dbg !1234
  ...
  %global163 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global162, i32 0, i32 17
  %tmp164 = load i16, i16* %global163, align 2
  %tmp165 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global166 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp165, i32 0, i32 1
  %global167 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global166, i32 0, i32 17
...
if.then33:                                        ; preds = %if.end29
  ...
  %global170 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global169, i32 0, i32 13
  ...
  %global174 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global173, i32 0, i32 13
...
do.body34:                                        ; preds = %do.cond40, %if.then33
  ...
  %global177 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global176, i32 0, i32 16
  ...
  %global181 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global180, i32 0, i32 16
  store i16 %tmp178, i16* %global181, align 2
  %tmp182 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global183 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp182, i32 0, i32 1
  %global184 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global183, i32 0, i32 10
  %tmp185 = load i16, i16* %global184, align 2
  %tmp186 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global187 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp186, i32 0, i32 1
  %global188 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global187, i32 0, i32 10
  ...
  %global190 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp189, i32 0, i32 1
  %global191 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global190, i32 0, i32 14
  %array192 = getelementptr inbounds [16 x i16], [16 x i16]* %global191, i16 0, i16 0
  %cast193 = bitcast i16* %array192 to i8*
  %tmp194 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global195 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp194, i32 0, i32 1
  %global196 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global195, i32 0, i32 14
  %array197 = getelementptr inbounds [16 x i16], [16 x i16]* %global196, i16 0, i16 0
  %cast198 = bitcast i16* %array197 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast193, i8* align 2 %cast198, i16 32, i1 false), !dbg !1246
  ...
  %global200 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp199, i32 0, i32 1
  %global201 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global200, i32 0, i32 17
  %tmp202 = load i16, i16* %global201, align 2
  %tmp203 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global204 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp203, i32 0, i32 1
  %global205 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global204, i32 0, i32 17
...
if.then38:                                        ; preds = %do.body34
  ...
  %global208 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global207, i32 0, i32 17
  ...
  %global212 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global211, i32 0, i32 17
...
if.end39:                                         ; preds = %if.then38, %do.body34
  ...
  %array216 = getelementptr inbounds [16 x i16], [16 x i16]* %global215, i16 0, i16 0
  ...
  %global220 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global219, i32 0, i32 0
  %array221 = getelementptr inbounds [16 x i16], [16 x i16]* %global220, i16 0, i16 0
  %cast222 = bitcast i16* %array221 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast217, i8* align 2 %cast222, i16 32, i1 false), !dbg !1255
...
if.then47:                                        ; preds = %if.end44
  ...
  %global225 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global224, i32 0, i32 15
  %array226 = getelementptr inbounds [16 x i16], [16 x i16]* %global225, i16 0, i16 0
  ...
  %global230 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global229, i32 0, i32 15
  %array231 = getelementptr inbounds [16 x i16], [16 x i16]* %global230, i16 0, i16 0
  %cast232 = bitcast i16* %array231 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast227, i8* align 2 %cast232, i16 32, i1 false), !dbg !1267
  ...
  %global235 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global234, i32 0, i32 17
  %tmp236 = load i16, i16* %global235, align 2
  %tmp237 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global238 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp237, i32 0, i32 1
  %global239 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global238, i32 0, i32 17
  ...
  %global242 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global241, i32 0, i32 11
  %array243 = getelementptr inbounds [16 x i16], [16 x i16]* %global242, i16 0, i16 0
  %cast244 = bitcast i16* %array243 to i8*
  %tmp245 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global246 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp245, i32 0, i32 1
  %global247 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global246, i32 0, i32 11
  %array248 = getelementptr inbounds [16 x i16], [16 x i16]* %global247, i16 0, i16 0
  %cast249 = bitcast i16* %array248 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast244, i8* align 2 %cast249, i16 32, i1 false), !dbg !1267
  ...
  %global252 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global251, i32 0, i32 5
  ...
  %global256 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global255, i32 0, i32 5
...
if.then52:                                        ; preds = %if.else48
  ...
  %global258 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp257, i32 0, i32 1
  %global259 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global258, i32 0, i32 6
  %array260 = getelementptr inbounds [16 x i16], [16 x i16]* %global259, i16 0, i16 0
  ...
  %global264 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global263, i32 0, i32 6
  %array265 = getelementptr inbounds [16 x i16], [16 x i16]* %global264, i16 0, i16 0
  %cast266 = bitcast i16* %array265 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast261, i8* align 2 %cast266, i16 32, i1 false), !dbg !1274
  ...
  %global269 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global268, i32 0, i32 17
  ...
  %global273 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global272, i32 0, i32 17
