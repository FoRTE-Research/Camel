...
if.end4:                                          ; preds = %if.end, %if.then
  ...
  call void asm sideeffect "mov $0, SP", "ri"(i16 %3) #5, !dbg !133, !srcloc !136
  %4 = bitcast i16* %__x to i8*, !dbg !137
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #5, !dbg !137
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !103, metadata !DIExpression()), !dbg !137
  %5 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !137, !srcloc !138
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #5, !dbg !139
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #5, !dbg !141
  call void @llvm.dbg.declare(metadata i16* %__x5, metadata !105, metadata !DIExpression()), !dbg !141
  %11 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !141, !srcloc !142
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %13) #5, !dbg !143
...
; Function Attrs: nounwind
define dso_local void @commit() #0 !dbg !171 {
entry:
  %__x = alloca i16, align 2
  %tmp = alloca i16, align 2
...
if.then:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #5, !dbg !194
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !173, metadata !DIExpression()), !dbg !194
  %3 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !194, !srcloc !195
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #5, !dbg !196
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #5, !dbg !198
  call void @llvm.dbg.declare(metadata i16* %__x1, metadata !178, metadata !DIExpression()), !dbg !198
  %9 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !198, !srcloc !199
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #5, !dbg !200
...
if.else:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %19) #5, !dbg !220
  call void @llvm.dbg.declare(metadata i16* %__x7, metadata !180, metadata !DIExpression()), !dbg !220
  %20 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !220, !srcloc !221
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #5, !dbg !222
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %25) #5, !dbg !224
  call void @llvm.dbg.declare(metadata i16* %__x10, metadata !183, metadata !DIExpression()), !dbg !224
  %26 = call i16 asm sideeffect "mov SP, $0", "=r"() #5, !dbg !224, !srcloc !225
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #5, !dbg !226
...
; Function Attrs: nounwind
define dso_local void @task_init() #0 !dbg !242 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %8) #5, !dbg !269
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %11) #5, !dbg !276
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %20) #5, !dbg !285
  %21 = bitcast %struct._node_t* %node to i8*, !dbg !285
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %21) #5, !dbg !285
...
; Function Attrs: nounwind
define dso_local void @task_sample() #0 !dbg !291 {
entry:
  %next_letter_idx = alloca i16, align 2
  %0 = bitcast i16* %next_letter_idx to i8*, !dbg !294
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !294
...
if.end12:                                         ; preds = %if.else, %if.then4
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %12) #5, !dbg !322
  ret void, !dbg !322
}

; Function Attrs: nounwind
define dso_local void @task_measure_temp() #0 !dbg !323 {
entry:
  %prev_sample = alloca i16, align 2
  %sample = alloca i16, align 2
  %0 = bitcast i16* %prev_sample to i8*, !dbg !327
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !327
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #5, !dbg !331
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %10) #5, !dbg !344
  %11 = bitcast i16* %prev_sample to i8*, !dbg !344
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #5, !dbg !344
  ret void, !dbg !344
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !352
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %3) #5, !dbg !358
  ret i16 %2, !dbg !359
}

; Function Attrs: nounwind
define dso_local void @task_letterize() #0 !dbg !360 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !365
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %5) #5, !dbg !375
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %7) #5, !dbg !379
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %14) #5, !dbg !390
  %15 = bitcast i16* %letter_shift to i8*, !dbg !390
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %15) #5, !dbg !390
  %16 = bitcast i16* %letter_idx to i8*, !dbg !390
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %16) #5, !dbg !390
  ret void, !dbg !390
}

; Function Attrs: nounwind
define dso_local void @task_compress() #0 !dbg !391 {
entry:
  %parent_node = alloca %struct._node_t, align 2
  %parent = alloca i16, align 2
  %0 = bitcast %struct._node_t* %parent_node to i8*, !dbg !395
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %0) #5, !dbg !395
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #5, !dbg !397
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %19) #5, !dbg !418
  %20 = bitcast %struct._node_t* %parent_node to i8*, !dbg !418
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %20) #5, !dbg !418
  ret void, !dbg !418
}

; Function Attrs: nounwind
define dso_local void @task_find_sibling() #0 !dbg !419 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !427
...
if.then:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #5, !dbg !432
...
cleanup:                                          ; preds = %if.end20, %if.then14, %if.then7
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #5, !dbg !465
...
if.end21:                                         ; preds = %cleanup.cont, %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %23) #5, !dbg !467
...
if.end34:                                         ; preds = %if.else31, %if.then28
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %32) #5, !dbg !484
...
cleanup35:                                        ; preds = %if.end34, %cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %33) #5, !dbg !484
...
; Function Attrs: nounwind
define dso_local void @task_add_node() #0 !dbg !485 {
entry:
  %sibling_node = alloca %struct._node_t*, align 2
  %i = alloca i16, align 2
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #5, !dbg !494
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #5, !dbg !496
...
if.then:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #5, !dbg !506
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %14) #5, !dbg !515
  br label %if.end, !dbg !516

if.else:                                          ; preds = %entry
  %15 = bitcast %struct._node_t* %sibling_node_obj to i8*, !dbg !517
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %15) #5, !dbg !517
  ...
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %23) #5, !dbg !525
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %24 = bitcast i16* %i to i8*, !dbg !526
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %24) #5, !dbg !526
  %25 = bitcast %struct._node_t** %sibling_node to i8*, !dbg !526
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %25) #5, !dbg !526
  ret void, !dbg !526
}

; Function Attrs: nounwind
define dso_local void @task_add_insert() #0 !dbg !527 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #5, !dbg !546
  ...
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %5) #5, !dbg !549
  ...
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %8) #5, !dbg !553
...
if.then9:                                         ; preds = %if.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %13) #5, !dbg !559
  ...
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %23) #5, !dbg !568
  br label %if.end22, !dbg !569

if.else:                                          ; preds = %if.end
  %24 = bitcast %struct._node_t* %last_sibling_node to i8*, !dbg !570
  call void @llvm.lifetime.start.p0i8(i64 6, i8* %24) #5, !dbg !570
  ...
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %34) #5, !dbg !579
  br label %if.end22
...
if.end22:                                         ; preds = %if.else, %if.then9
  ...
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %45) #5, !dbg !589
  %46 = bitcast %struct._node_t* %child_node to i8*, !dbg !589
  call void @llvm.lifetime.end.p0i8(i64 6, i8* %46) #5, !dbg !589
  %47 = bitcast i16* %child to i8*, !dbg !589
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %47) #5, !dbg !589
  ret void, !dbg !589
}

; Function Attrs: nounwind
define dso_local void @task_append_compressed() #0 !dbg !590 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_done() #0 !dbg !599 {
entry:
  call void @exit(i16 0) #6, !dbg !600
  unreachable, !dbg !600
}
