...
if.end4:                                          ; preds = %if.end, %if.then
  ...
  call void asm sideeffect "mov $0, SP", "ri"(i16 %3) #6, !dbg !129, !srcloc !132
  %4 = bitcast i16* %__x to i8*, !dbg !133
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #6, !dbg !133
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !99, metadata !DIExpression()), !dbg !133
  %5 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !133, !srcloc !134
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #6, !dbg !135
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #6, !dbg !137
  call void @llvm.dbg.declare(metadata i16* %__x5, metadata !101, metadata !DIExpression()), !dbg !137
  %11 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !137, !srcloc !138
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %13) #6, !dbg !139
...
; Function Attrs: nounwind
define dso_local void @commit() #0 !dbg !167 {
entry:
  %__x = alloca i16, align 2
  %tmp = alloca i16, align 2
...
if.then:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #6, !dbg !190
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !169, metadata !DIExpression()), !dbg !190
  %3 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !190, !srcloc !191
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #6, !dbg !192
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #6, !dbg !194
  call void @llvm.dbg.declare(metadata i16* %__x1, metadata !174, metadata !DIExpression()), !dbg !194
  %9 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !194, !srcloc !195
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #6, !dbg !196
...
if.else:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %19) #6, !dbg !216
  call void @llvm.dbg.declare(metadata i16* %__x7, metadata !176, metadata !DIExpression()), !dbg !216
  %20 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !216, !srcloc !217
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #6, !dbg !218
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %25) #6, !dbg !220
  call void @llvm.dbg.declare(metadata i16* %__x10, metadata !179, metadata !DIExpression()), !dbg !220
  %26 = call i16 asm sideeffect "mov SP, $0", "=r"() #6, !dbg !220, !srcloc !221
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #6, !dbg !222
...
; Function Attrs: nounwind
define dso_local void @task_init() #0 !dbg !238 {
entry:
  %i = alloca i16, align 2
  %0 = bitcast i16* %i to i8*, !dbg !241
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #6, !dbg !241
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %10) #6, !dbg !274
  ret void, !dbg !274
}

; Function Attrs: nounwind
define dso_local void @task_generate_key() #0 !dbg !275 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_calc_indexes() #0 !dbg !282 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_calc_indexes_index_1() #0 !dbg !298 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #6, !dbg !314
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %3) #6, !dbg !320
  ret i16 %and, !dbg !321
}

; Function Attrs: noinline nounwind
define dso_local void @task_calc_indexes_index_2() #4 !dbg !322 {
entry:
  %fp_hash = alloca i16, align 2
  %0 = bitcast i16* %fp_hash to i8*, !dbg !325
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #6, !dbg !325
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #6, !dbg !335
  ret void, !dbg !335
}

; Function Attrs: nounwind
define dso_local void @task_add() #0 !dbg !336 {
entry:
...
if.else24:                                        ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %20) #6, !dbg !367
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %21) #6, !dbg !369
...
if.end:                                           ; preds = %if.else34, %if.then26
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %43) #6, !dbg !401
  %44 = bitcast i16* %fp_victim to i8*, !dbg !401
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %44) #6, !dbg !401
  br label %if.end52
...
; Function Attrs: nounwind
define dso_local void @task_relocate() #0 !dbg !403 {
entry:
  %fp_victim = alloca i16, align 2
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #6, !dbg !408
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #6, !dbg !411
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %5) #6, !dbg !415
...
cleanup:                                          ; preds = %if.end11, %if.then8, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %30) #6, !dbg !453
  %31 = bitcast i16* %fp_hash_victim to i8*, !dbg !453
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %31) #6, !dbg !453
  %32 = bitcast i16* %fp_victim to i8*, !dbg !453
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %32) #6, !dbg !453
...
; Function Attrs: nounwind
define dso_local void @task_insert_done() #0 !dbg !454 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_lookup_search() #0 !dbg !470 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_lookup_done() #0 !dbg !497 {
entry:
...
; Function Attrs: nounwind
define dso_local void @task_done() #0 !dbg !504 {
entry:
  call void @exit(i16 0) #7, !dbg !505
  unreachable, !dbg !505
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #6, !dbg !569
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #6, !dbg !571
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #6, !dbg !597
  %12 = bitcast i16* %hash to i8*, !dbg !597
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %12) #6, !dbg !597
  ret i16 %10, !dbg !598
}
