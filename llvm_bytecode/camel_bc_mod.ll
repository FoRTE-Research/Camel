...
if.end4:                                          ; preds = %if.end, %if.then
  ...
  call void asm sideeffect "mov $0, SP", "ri"(i16 %3) #8, !dbg !123, !srcloc !126
  %4 = bitcast i16* %__x to i8*, !dbg !127
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #8, !dbg !127
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !93, metadata !DIExpression()), !dbg !127
  %5 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !127, !srcloc !128
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #8, !dbg !129
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #8, !dbg !131
  call void @llvm.dbg.declare(metadata i16* %__x5, metadata !95, metadata !DIExpression()), !dbg !131
  %11 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !131, !srcloc !132
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %13) #8, !dbg !133
...
define dso_local void @commit() #4 !dbg !161 {
entry:
  %__x = alloca i16, align 2
  %tmp = alloca i16, align 2
...
if.then:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #8, !dbg !184
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !163, metadata !DIExpression()), !dbg !184
  %3 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !184, !srcloc !185
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #8, !dbg !186
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #8, !dbg !188
  call void @llvm.dbg.declare(metadata i16* %__x1, metadata !168, metadata !DIExpression()), !dbg !188
  %9 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !188, !srcloc !189
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #8, !dbg !190
...
if.else:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %19) #8, !dbg !210
  call void @llvm.dbg.declare(metadata i16* %__x7, metadata !170, metadata !DIExpression()), !dbg !210
  %20 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !210, !srcloc !211
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #8, !dbg !212
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %25) #8, !dbg !214
  call void @llvm.dbg.declare(metadata i16* %__x10, metadata !173, metadata !DIExpression()), !dbg !214
  %26 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !214, !srcloc !215
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #8, !dbg !216
...
define dso_local void @naked() #5 !dbg !232 {
entry:
  call void asm sideeffect "ret", ""() #8, !dbg !233, !srcloc !234
  unreachable, !dbg !235
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_init() #6 !dbg !236 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_select_func() #6 !dbg !262 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_bit_count() #6 !dbg !272 {
entry:
  %tmp_seed = alloca i32, align 2
  %temp = alloca i16, align 2
  %0 = bitcast i32* %tmp_seed to i8*, !dbg !276
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #8, !dbg !276
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %6) #8, !dbg !284
...
if.end:                                           ; preds = %do.end, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %16) #8, !dbg !305
  %17 = bitcast i32* %tmp_seed to i8*, !dbg !305
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %17) #8, !dbg !305
  ret void, !dbg !305
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_bitcount() #6 !dbg !306 {
entry:
  %tmp_seed = alloca i32, align 2
  %0 = bitcast i32* %tmp_seed to i8*, !dbg !309
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #8, !dbg !309
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %21) #8, !dbg !357
  ret void, !dbg !357
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !365
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #8, !dbg !380
  ret i16 %6, !dbg !381
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_ntbl_bitcnt() #6 !dbg !382 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_ntbl_bitcount() #6 !dbg !394 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_BW_btbl_bitcount() #6 !dbg !450 {
entry:
  %U = alloca %union.anon, align 2
  %0 = bitcast %union.anon* %U to i8*, !dbg !461
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #8, !dbg !461
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %18) #8, !dbg !489
  ret void, !dbg !489
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_AR_btbl_bitcount() #6 !dbg !490 {
entry:
  %Ptr = alloca i8*, align 2
  %Accu = alloca i16, align 2
  %0 = bitcast i8** %Ptr to i8*, !dbg !494
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !494
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #8, !dbg !498
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #8, !dbg !525
  %28 = bitcast i8** %Ptr to i8*, !dbg !525
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #8, !dbg !525
  ret void, !dbg !525
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_bit_shifter() #6 !dbg !526 {
entry:
  %i = alloca i16, align 2
  %nn = alloca i16, align 2
  %tmp_seed = alloca i32, align 2
  %0 = bitcast i16* %i to i8*, !dbg !531
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !531
  call void @llvm.dbg.declare(metadata i16* %i, metadata !528, metadata !DIExpression()), !dbg !532
  %1 = bitcast i16* %nn to i8*, !dbg !531
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #8, !dbg !531
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #8, !dbg !534
...
for.end:                                          ; preds = %land.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #8, !dbg !567
  %21 = bitcast i16* %nn to i8*, !dbg !567
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %21) #8, !dbg !567
  %22 = bitcast i16* %i to i8*, !dbg !567
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #8, !dbg !567
  ret void, !dbg !567
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_done() #6 !dbg !568 {
entry:
  call void @exit(i16 0) #9, !dbg !569
  unreachable, !dbg !569
}
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast, i8* align 2 %BCast4, i16 22, i1 false), !dbg !579
...
while.body:                                       ; preds = %entry, %if.end81
  ...
  %global5 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global, i32 0, i32 8
  ...
  %global9 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global8, i32 0, i32 8
  ...
  %global12 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global11, i32 0, i32 9
  ...
  %global16 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global15, i32 0, i32 9
  ...
  %global19 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global18, i32 0, i32 7
  ...
  %global23 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global22, i32 0, i32 7
...
while.body4:                                      ; preds = %while.cond1
  ...
  %global26 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global25, i32 0, i32 8
  ...
  %global30 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global29, i32 0, i32 8
  ...
  %global40 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global39, i32 0, i32 9
  ...
  %global44 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global43, i32 0, i32 9
...
while.body13:                                     ; preds = %while.cond9
  ...
  %global47 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global46, i32 0, i32 8
  ...
  %global51 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global50, i32 0, i32 8
...
while.body24:                                     ; preds = %while.cond20
  ...
  %global68 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global67, i32 0, i32 2
  ...
  %global72 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global71, i32 0, i32 2
  ...
  %global75 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global74, i32 0, i32 8
  ...
  %global79 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global78, i32 0, i32 8
  ...
  %global82 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global81, i32 0, i32 9
  ...
  %global86 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global85, i32 0, i32 9
...
while.body35:                                     ; preds = %while.cond31
  ...
  %global89 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global88, i32 0, i32 3
  ...
  %global93 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global92, i32 0, i32 3
  ...
  %global103 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global102, i32 0, i32 9
  ...
  %global107 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global106, i32 0, i32 9
...
while.body46:                                     ; preds = %while.cond42
  ...
  %global110 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global109, i32 0, i32 4
  ...
  %tmp115 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global116 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp115, i32 0, i32 1
  %global117 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global116, i32 0, i32 8
  ...
  %global121 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global120, i32 0, i32 8
  ...
  %global124 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global123, i32 0, i32 9
  %tmp125 = load i16, i16* %global124, align 2
  %tmp126 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global127 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp126, i32 0, i32 1
  %global128 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global127, i32 0, i32 9
...
while.body57:                                     ; preds = %while.cond53
  ...
  %global131 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global130, i32 0, i32 5
  %tmp132 = load i16, i16* %global131, align 2
  %tmp133 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global134 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp133, i32 0, i32 1
  %global135 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global134, i32 0, i32 5
  store i16 %tmp132, i16* %global135, align 2
  %tmp136 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global137 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp136, i32 0, i32 1
  %global138 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global137, i32 0, i32 8
  ...
  %tmp143 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global144 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp143, i32 0, i32 1
  %global145 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global144, i32 0, i32 9
  %tmp146 = load i16, i16* %global145, align 2
  %tmp147 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global148 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp147, i32 0, i32 1
  %global149 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global148, i32 0, i32 9
...
while.body68:                                     ; preds = %while.cond64
  ...
  %global152 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global151, i32 0, i32 6
  ...
  %global156 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global155, i32 0, i32 6
  store i16 %tmp153, i16* %global156, align 2
  %tmp157 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global158 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp157, i32 0, i32 1
  %global159 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global158, i32 0, i32 8
  ...
  %tmp164 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global165 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp164, i32 0, i32 1
  %global166 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global165, i32 0, i32 9
  %tmp167 = load i16, i16* %global166, align 2
  %tmp168 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global169 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp168, i32 0, i32 1
  %global170 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global169, i32 0, i32 9
