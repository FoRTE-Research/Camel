...
entry:
  call void @exit(i16 0) #6, !dbg !419
  unreachable, !dbg !419
}
...
do.end:                                           ; preds = %if.end
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast, i8* align 2 %BCast3, i16 22, i1 false), !dbg !429
...
while.body:                                       ; preds = %do.end, %if.end167
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast6, i8* align 2 %BCast9, i16 22, i1 false), !dbg !439
...
while.body18:                                     ; preds = %while.cond15
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast12, i8* align 2 %BCast15, i16 22, i1 false), !dbg !457
...
while.body38:                                     ; preds = %while.cond34
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast18, i8* align 2 %BCast21, i16 22, i1 false), !dbg !478
...
while.body59:                                     ; preds = %while.cond55
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast24, i8* align 2 %BCast27, i16 22, i1 false), !dbg !499
...
while.body80:                                     ; preds = %while.cond76
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast30, i8* align 2 %BCast33, i16 22, i1 false), !dbg !520
...
while.body101:                                    ; preds = %while.cond97
  ...
  %globals36 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %unsafe34, i32 0, i32 1
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast37, i8* align 2 %BCast40, i16 22, i1 false), !dbg !541
...
while.body122:                                    ; preds = %while.cond118
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast43, i8* align 2 %BCast46, i16 22, i1 false), !dbg !562
...
while.body143:                                    ; preds = %while.cond139
  ...
  %globals52 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe50, i32 0, i32 1
  %BCast53 = bitcast %struct.camel_global_t* %globals52 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast49, i8* align 2 %BCast53, i16 22, i1 false), !dbg !583
...
if.then159:                                       ; preds = %if.else155
  ...
  %globals58 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe57, i32 0, i32 1
  %BCast59 = bitcast %struct.camel_global_t* %globals58 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast56, i8* align 2 %BCast59, i16 22, i1 false), !dbg !600
