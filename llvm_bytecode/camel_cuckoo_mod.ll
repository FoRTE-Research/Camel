...
while.body:                                       ; preds = %while.cond
  %tmp5 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global6 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp5, i32 0, i32 1
  %cast7 = bitcast %struct.camel_global_t* %global6 to i8*
  %tmp8 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global9 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp8, i32 0, i32 1
  %cast10 = bitcast %struct.camel_global_t* %global9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast7, i8* %cast10, i64 276, i1 false)
...
do.end:                                           ; preds = %if.end
  ...
  %global12 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp11, i32 0, i32 1
  %cast13 = bitcast %struct.camel_global_t* %global12 to i8*
  %tmp14 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global15 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp14, i32 0, i32 1
  %cast16 = bitcast %struct.camel_global_t* %global15 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast13, i8* %cast16, i64 276, i1 false)
...
do.end56:                                         ; preds = %if.end55
  ...
  %cast19 = bitcast %struct.camel_global_t* %global18 to i8*
  ...
  %cast22 = bitcast %struct.camel_global_t* %global21 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast19, i8* %cast22, i64 276, i1 false)
...
do.end86:                                         ; preds = %if.end85
  %tmp23 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global24 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp23, i32 0, i32 1
  %cast25 = bitcast %struct.camel_global_t* %global24 to i8*
  %tmp26 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global27 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp26, i32 0, i32 1
  %cast28 = bitcast %struct.camel_global_t* %global27 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast25, i8* %cast28, i64 276, i1 false)
...
if.then119:                                       ; preds = %do.end116
  %tmp29 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global30 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp29, i32 0, i32 1
  %cast31 = bitcast %struct.camel_global_t* %global30 to i8*
  ...
  %cast34 = bitcast %struct.camel_global_t* %global33 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast31, i8* %cast34, i64 276, i1 false)
...
while.body168:                                    ; preds = %land.end
  ...
  %cast37 = bitcast %struct.camel_global_t* %global36 to i8*
  ...
  %cast40 = bitcast %struct.camel_global_t* %global39 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast37, i8* %cast40, i64 276, i1 false)
...
if.end200:                                        ; preds = %while.end, %land.lhs.true, %do.end149
  ...
  %cast43 = bitcast %struct.camel_global_t* %global42 to i8*
  ...
  %cast46 = bitcast %struct.camel_global_t* %global45 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast43, i8* %cast46, i64 276, i1 false)
...
if.else232:                                       ; preds = %do.end116
  %tmp47 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global48 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp47, i32 0, i32 1
  %cast49 = bitcast %struct.camel_global_t* %global48 to i8*
  %tmp50 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global51 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp50, i32 0, i32 1
  %cast52 = bitcast %struct.camel_global_t* %global51 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast49, i8* %cast52, i64 276, i1 false)
...
do.end263:                                        ; preds = %if.end262
  %tmp53 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global54 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp53, i32 0, i32 1
  %cast55 = bitcast %struct.camel_global_t* %global54 to i8*
  %tmp56 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global57 = getelementptr %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp56, i32 0, i32 1
  %cast58 = bitcast %struct.camel_global_t* %global57 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast55, i8* %cast58, i64 276, i1 false)
...
while.end296:                                     ; preds = %while.cond
  ...
  %cast61 = bitcast %struct.camel_global_t* %global60 to i8*
  ...
  %cast64 = bitcast %struct.camel_global_t* %global63 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %cast61, i8* %cast64, i64 276, i1 false)
...
!412 = !DILocation(line: 550, column: 5, scope: !404)
