...
if.end4:                                          ; preds = %if.end, %if.then
  ...
  call void asm sideeffect "mov $0, SP", "ri"(i16 %3) #8, !dbg !150, !srcloc !153
  %4 = bitcast i16* %__x to i8*, !dbg !154
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %4) #8, !dbg !154
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !120, metadata !DIExpression()), !dbg !154
  %5 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !154, !srcloc !155
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %7) #8, !dbg !156
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #8, !dbg !158
  call void @llvm.dbg.declare(metadata i16* %__x5, metadata !122, metadata !DIExpression()), !dbg !158
  %11 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !158, !srcloc !159
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %13) #8, !dbg !160
...
define dso_local void @commit() #4 !dbg !188 {
entry:
  %__x = alloca i16, align 2
  %tmp = alloca i16, align 2
...
if.then:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %2) #8, !dbg !211
  call void @llvm.dbg.declare(metadata i16* %__x, metadata !190, metadata !DIExpression()), !dbg !211
  %3 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !211, !srcloc !212
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #8, !dbg !213
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %8) #8, !dbg !215
  call void @llvm.dbg.declare(metadata i16* %__x1, metadata !195, metadata !DIExpression()), !dbg !215
  %9 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !215, !srcloc !216
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %11) #8, !dbg !217
...
if.else:                                          ; preds = %do.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %19) #8, !dbg !237
  call void @llvm.dbg.declare(metadata i16* %__x7, metadata !197, metadata !DIExpression()), !dbg !237
  %20 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !237, !srcloc !238
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %22) #8, !dbg !239
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %25) #8, !dbg !241
  call void @llvm.dbg.declare(metadata i16* %__x10, metadata !200, metadata !DIExpression()), !dbg !241
  %26 = call i16 asm sideeffect "mov SP, $0", "=r"() #8, !dbg !241, !srcloc !242
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #8, !dbg !243
...
define dso_local void @task_init() #5 !dbg !299 {
entry:
...
if.end12:                                         ; preds = %if.then11, %if.end7
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %9) #8, !dbg !338
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %10) #8, !dbg !340
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb36, %sw.bb27, %sw.bb
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %29) #8, !dbg !391
  %30 = bitcast i16* %mode to i8*, !dbg !391
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %30) #8, !dbg !391
  %31 = bitcast i16* %pin_state to i8*, !dbg !391
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %31) #8, !dbg !391
  ret void, !dbg !391
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_resetStats() #5 !dbg !392 {
entry:
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_sample() #5 !dbg !405 {
entry:
  %sample = alloca %struct.threeAxis_t_8, align 1
  %0 = bitcast %struct.threeAxis_t_8* %sample to i8*, !dbg !408
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %0) #8, !dbg !408
  ...
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %10) #8, !dbg !418
  ret void, !dbg !418
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_transform() #5 !dbg !419 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #8, !dbg !428
  ...
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %2) #8, !dbg !430
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #8, !dbg !432
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %5) #8, !dbg !438
  br label %for.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %40) #8, !dbg !498
  %41 = bitcast %struct.threeAxis_t_8** %sample to i8*, !dbg !498
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %41) #8, !dbg !498
  ret void, !dbg !498
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_featurize() #5 !dbg !499 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %0) #8, !dbg !508
  ...
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %1) #8, !dbg !508
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #8, !dbg !523
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #8, !dbg !525
...
for.end137:                                       ; preds = %for.cond37
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %65) #8, !dbg !640
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %72) #8, !dbg !659
  ...
  %call = call double @sqrt(double %conv183) #8, !dbg !679
  ...
  %call187 = call double @sqrt(double %conv186) #8, !dbg !684
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb193, %sw.bb
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %89) #8, !dbg !699
  %90 = bitcast i16* %meanmag to i8*, !dbg !699
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %90) #8, !dbg !699
  %91 = bitcast i16* %i to i8*, !dbg !699
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %91) #8, !dbg !699
  %92 = bitcast %struct.features_t* %features to i8*, !dbg !699
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %92) #8, !dbg !699
  %93 = bitcast %struct.threeAxis_t_8* %stddev to i8*, !dbg !699
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %93) #8, !dbg !699
  %94 = bitcast %struct.threeAxis_t_8* %mean to i8*, !dbg !699
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %94) #8, !dbg !699
  ret void, !dbg !699
}
...
; Function Attrs: noinline nounwind optnone
define dso_local void @task_classify() #5 !dbg !700 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !716
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #8, !dbg !718
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %4) #8, !dbg !724
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %5) #8, !dbg !726
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %11) #8, !dbg !743
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %24) #8, !dbg !761
...
cond.end44:                                       ; preds = %cond.false37, %cond.true30
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %37) #8, !dbg !779
...
cond.end66:                                       ; preds = %cond.false59, %cond.true52
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %50) #8, !dbg !797
...
if.end100:                                        ; preds = %if.else98, %if.then96
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %71) #8, !dbg !835
  %72 = bitcast i32* %move_mean_err to i8*, !dbg !835
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %72) #8, !dbg !835
  %73 = bitcast i32* %stat_sd_err to i8*, !dbg !835
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %73) #8, !dbg !835
  %74 = bitcast i32* %stat_mean_err to i8*, !dbg !835
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %74) #8, !dbg !835
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %80) #8, !dbg !847
  %81 = bitcast i32* %meanmag to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %81) #8, !dbg !847
  %82 = bitcast i16* %class to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %82) #8, !dbg !847
  %83 = bitcast i16* %i to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %83) #8, !dbg !847
  %84 = bitcast i16* %stat_less_error to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %84) #8, !dbg !847
  %85 = bitcast i16* %move_less_error to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %85) #8, !dbg !847
  ret void, !dbg !847
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_stats() #5 !dbg !848 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !857
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #8, !dbg !857
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %12) #8, !dbg !874
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %17) #8, !dbg !880
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %22) #8, !dbg !886
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %27) #8, !dbg !891
  %28 = bitcast i16* %resultMovingPct to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %28) #8, !dbg !891
  %29 = bitcast i16* %resultStationaryPct to i8*, !dbg !891
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %29) #8, !dbg !891
  br label %if.end, !dbg !892

if.end:                                           ; preds = %if.then, %sw.epilog
  %30 = bitcast i16* %stationaryCount to i8*, !dbg !893
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %30) #8, !dbg !893
  %31 = bitcast i16* %movingCount to i8*, !dbg !893
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %31) #8, !dbg !893
  ret void, !dbg !893
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_warmup() #5 !dbg !894 {
entry:
  %sample = alloca %struct.threeAxis_t_8, align 1
  %0 = bitcast %struct.threeAxis_t_8* %sample to i8*, !dbg !897
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %0) #8, !dbg !897
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %9) #8, !dbg !914
  ret void, !dbg !914
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_train() #5 !dbg !915 {
entry:
  %trainingSetSize = alloca i16, align 2
  %class = alloca i16, align 2
  %0 = bitcast i16* %trainingSetSize to i8*, !dbg !919
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %0) #8, !dbg !919
  ...
  call void @llvm.lifetime.start.p0i8(i64 2, i8* %1) #8, !dbg !921
...
sw.epilog:                                        ; preds = %entry, %sw.bb6, %sw.bb
  ...
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %18) #8, !dbg !936
  %19 = bitcast i16* %trainingSetSize to i8*, !dbg !936
  call void @llvm.lifetime.end.p0i8(i64 2, i8* %19) #8, !dbg !936
  ret void, !dbg !936
}

; Function Attrs: noinline nounwind optnone
define dso_local void @task_done() #5 !dbg !937 {
entry:
  call void @exit(i16 0) #9, !dbg !938
  unreachable, !dbg !938
}

; Function Attrs: noreturn
declare dso_local void @exit(i16) #7
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast, i8* align 2 %BCast4, i16 164, i1 false), !dbg !948
...
while.body:                                       ; preds = %entry, %if.then16, %while.end49
  ...
  %global5 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global, i32 0, i32 14
  ...
  %global9 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global8, i32 0, i32 14
  ...
  %global12 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global11, i32 0, i32 0
  ...
  %global16 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global15, i32 0, i32 0
  ...
  %global19 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global18, i32 0, i32 1
  ...
  %global23 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global22, i32 0, i32 1
  ...
  %global26 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global25, i32 0, i32 12
  ...
  %global30 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global29, i32 0, i32 12
  ...
  %global33 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global32, i32 0, i32 2
  ...
  %global37 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global36, i32 0, i32 2
  ...
  %global40 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global39, i32 0, i32 11
  ...
  %global44 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global43, i32 0, i32 11
...
while.body7:                                      ; preds = %while.cond4
  ...
  %global47 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global46, i32 0, i32 13
  ...
  %global51 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global50, i32 0, i32 13
  ...
  %global54 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global53, i32 0, i32 1
  ...
  %global58 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global57, i32 0, i32 1
  ...
  %global61 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global60, i32 0, i32 10
  ...
  %global65 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global64, i32 0, i32 10
...
if.then11:                                        ; preds = %if.else
  ...
  %global68 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global67, i32 0, i32 4
  ...
  %global72 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global71, i32 0, i32 4
  ...
  %global75 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global74, i32 0, i32 5
  ...
  %global79 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global78, i32 0, i32 5
  ...
  %global82 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global81, i32 0, i32 3
  ...
  %global89 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global88, i32 0, i32 11
  ...
  %global93 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global92, i32 0, i32 11
...
while.body24:                                     ; preds = %while.cond21
  ...
  %global96 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global95, i32 0, i32 6
  %tmp97 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global98 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp97, i32 0, i32 1
  %global99 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global98, i32 0, i32 11
  %load = load i16, i16* %global99, align 2
  %access = getelementptr inbounds [3 x %struct.threeAxis_t_8], [3 x %struct.threeAxis_t_8]* %global96, i16 0, i16 %load
  ...
  %global102 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global101, i32 0, i32 6
  %tmp103 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global104 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp103, i32 0, i32 1
  %global105 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global104, i32 0, i32 11
  %load106 = load i16, i16* %global105, align 2
  %access107 = getelementptr inbounds [3 x %struct.threeAxis_t_8], [3 x %struct.threeAxis_t_8]* %global102, i16 0, i16 %load106
  %cast = bitcast %struct.threeAxis_t_8* %access to i8*
  %cast108 = bitcast %struct.threeAxis_t_8* %access107 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast, i8* align 2 %cast108, i16 3, i1 false), !dbg !988
  ...
  %global111 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global110, i32 0, i32 11
  ...
  %global115 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global114, i32 0, i32 11
...
while.end25:                                      ; preds = %while.cond21
  ...
  %global118 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global117, i32 0, i32 11
  ...
  %global122 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global121, i32 0, i32 11
  ...
  %global125 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global124, i32 0, i32 6
  %array = getelementptr inbounds [3 x %struct.threeAxis_t_8], [3 x %struct.threeAxis_t_8]* %global125, i16 0, i16 0
  %cast126 = bitcast %struct.threeAxis_t_8* %array to i8*
  ...
  %global129 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global128, i32 0, i32 6
  %array130 = getelementptr inbounds [3 x %struct.threeAxis_t_8], [3 x %struct.threeAxis_t_8]* %global129, i16 0, i16 0
  %cast131 = bitcast %struct.threeAxis_t_8* %array130 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast126, i8* align 2 %cast131, i16 9, i1 false), !dbg !992
  ...
  %global134 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global133, i32 0, i32 7
  ...
  %global137 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global136, i32 0, i32 7
  %cast138 = bitcast %struct.features_t* %global134 to i8*
  %cast139 = bitcast %struct.features_t* %global137 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast138, i8* align 2 %cast139, i16 4, i1 false), !dbg !993
...
if.then33:                                        ; preds = %lor.lhs.false29, %while.end25
  ...
  %global142 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global141, i32 0, i32 8
  ...
  %global145 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global144, i32 0, i32 10
  %load146 = load i16, i16* %global145, align 2
  %access147 = getelementptr inbounds [16 x %struct.features_t], [16 x %struct.features_t]* %global142, i16 0, i16 %load146
  ...
  %global150 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global149, i32 0, i32 8
  ...
  %global153 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global152, i32 0, i32 10
  %load154 = load i16, i16* %global153, align 2
  %access155 = getelementptr inbounds [16 x %struct.features_t], [16 x %struct.features_t]* %global150, i16 0, i16 %load154
  %cast156 = bitcast %struct.features_t* %access147 to i8*
  %cast157 = bitcast %struct.features_t* %access155 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast156, i8* align 2 %cast157, i16 4, i1 false), !dbg !1001
  ...
  %global160 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global159, i32 0, i32 9
  ...
  %global163 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global162, i32 0, i32 10
  %load164 = load i16, i16* %global163, align 2
  %access165 = getelementptr inbounds [16 x %struct.features_t], [16 x %struct.features_t]* %global160, i16 0, i16 %load164
  ...
  %global168 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global167, i32 0, i32 9
  ...
  %global171 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global170, i32 0, i32 10
  %load172 = load i16, i16* %global171, align 2
  %access173 = getelementptr inbounds [16 x %struct.features_t], [16 x %struct.features_t]* %global168, i16 0, i16 %load172
  %cast174 = bitcast %struct.features_t* %access165 to i8*
  %cast175 = bitcast %struct.features_t* %access173 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %cast174, i8* align 2 %cast175, i16 4, i1 false), !dbg !1001
  ...
  %global178 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global177, i32 0, i32 10
  ...
  %global182 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global181, i32 0, i32 10
...
if.then42:                                        ; preds = %if.else38
  ...
  %global185 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global184, i32 0, i32 2
  ...
  %global189 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global188, i32 0, i32 2
  ...
  %global192 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global191, i32 0, i32 3
  ...
  %global196 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global195, i32 0, i32 3
  store i16 %tmp193, i16* %global196, align 2
  %tmp197 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global198 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp197, i32 0, i32 1
  %global199 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global198, i32 0, i32 4
  %tmp200 = load i16, i16* %global199, align 2
  %tmp201 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global202 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp201, i32 0, i32 1
  %global203 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global202, i32 0, i32 4
  store i16 %tmp200, i16* %global203, align 2
  %tmp204 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %global205 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp204, i32 0, i32 1
  %global206 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global205, i32 0, i32 5
  %tmp207 = load i16, i16* %global206, align 2
  %tmp208 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %global209 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %tmp208, i32 0, i32 1
  %global210 = getelementptr inbounds %struct.camel_global_t, %struct.camel_global_t* %global209, i32 0, i32 5
...
attributes #6 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
