...
do.end:                                           ; preds = %if.end
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast, i8* align 2 %BCast3, i16 164, i1 false), !dbg !767
...
while.body:                                       ; preds = %do.end, %if.then51, %while.end145
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast6, i8* align 2 %BCast9, i16 164, i1 false), !dbg !777
...
while.body21:                                     ; preds = %while.cond18
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast12, i8* align 2 %BCast16, i16 164, i1 false), !dbg !798
...
if.then36:                                        ; preds = %if.else32
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast19, i8* align 2 %BCast22, i16 164, i1 false), !dbg !815
...
while.body60:                                     ; preds = %while.cond57
  ...
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast25, i8* align 2 %BCast28, i16 164, i1 false), !dbg !839
...
while.end71:                                      ; preds = %while.cond57
  ...
  %globals34 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe32, i32 0, i32 1
  %BCast35 = bitcast %struct.camel_global_t* %globals34 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast31, i8* align 2 %BCast35, i16 164, i1 false), !dbg !851
...
do.end81:                                         ; preds = %if.end80
  ...
  %unsafe36 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %globals37 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %unsafe36, i32 0, i32 1
  %BCast38 = bitcast %struct.camel_global_t* %globals37 to i8*
  %safe39 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %globals40 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe39, i32 0, i32 1
  %BCast41 = bitcast %struct.camel_global_t* %globals40 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast38, i8* align 2 %BCast41, i16 164, i1 false), !dbg !860
...
if.then99:                                        ; preds = %lor.lhs.false95, %do.end91
  %unsafe42 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %globals43 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %unsafe42, i32 0, i32 1
  %BCast44 = bitcast %struct.camel_global_t* %globals43 to i8*
  %safe45 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %globals46 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe45, i32 0, i32 1
  %BCast47 = bitcast %struct.camel_global_t* %globals46 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast44, i8* align 2 %BCast47, i16 164, i1 false), !dbg !876
...
if.then118:                                       ; preds = %if.else114
  %unsafe48 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %globals49 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %unsafe48, i32 0, i32 1
  %BCast50 = bitcast %struct.camel_global_t* %globals49 to i8*
  %safe51 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %globals52 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe51, i32 0, i32 1
  %BCast53 = bitcast %struct.camel_global_t* %globals52 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast50, i8* align 2 %BCast53, i16 164, i1 false), !dbg !896
...
do.end128:                                        ; preds = %if.end127
  ...
  %unsafe54 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @unsafe, align 2
  %globals55 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %unsafe54, i32 0, i32 1
  %BCast56 = bitcast %struct.camel_global_t* %globals55 to i8*
  %safe57 = load %struct.camel_buffer_t*, %struct.camel_buffer_t** @safe, align 2
  %globals59 = getelementptr inbounds %struct.camel_buffer_t, %struct.camel_buffer_t* %safe57, i32 0, i32 1
  %BCast60 = bitcast %struct.camel_global_t* %globals59 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i16(i8* align 2 %BCast56, i8* align 2 %BCast60, i16 164, i1 false), !dbg !906
